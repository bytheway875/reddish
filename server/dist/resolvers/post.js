...
let PostResolver = class PostResolver {
    ...
    vote(postId, value, { req }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const existingVote = yield Upvote_1.Upvote.findOne({ userId, postId });
            if (existingVote && (existingVote === null || existingVote === void 0 ? void 0 : existingVote.value) !== realValue) {
